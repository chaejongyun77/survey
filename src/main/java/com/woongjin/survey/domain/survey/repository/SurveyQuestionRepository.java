...
public interface SurveyQuestionRepository extends JpaRepository<Question, Long> {
    ...
    List<Question> findBySurveyIdAndDeletedAtIsNullOrderBySortOrderAsc(Long surveyId);
}

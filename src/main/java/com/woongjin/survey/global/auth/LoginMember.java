package com.woongjin.survey.global.auth;
 ...
 * - 컨트롤러에서 @AuthenticationPrincipal LoginMember 로 바로 꺼내 사용
 *
 * 사용 예시:
 *   @GetMapping
 *   public String page(@AuthenticationPrincipal LoginMember loginMember) {
...
public class LoginMember extends User {
    ...
    public LoginMember(Long memberId, String loginId, String password,

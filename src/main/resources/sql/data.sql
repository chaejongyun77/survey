...
-- 조건분기: QST_ID=1(SINGLE) → PRNTS_ITM_ID=2(옵션2 선택 시) → CHLRN_QST_ID=6(분기 문항)
-- =============================================
...
(2, 'SINGLE',   '전반적인 서비스 만족도는 어떠셨나요?',                    1, 0, 6, 1, 1),
-- 2번: 복수선택
(2, 'MULTIPLE', '개선이 필요한 분야를 모두 선택해 주세요. (복수 선택 가능)', 0, 0, 0, 2, 1),
-- 3번: 주관식
(2, 'TEXT',     '서비스 이용 중 불편했던 점이나 개선 사항을 적어주세요.',    0, 0, 0, 3, 1),
-- 4번: 척도
(2, 'SCALE',    '이용하신 서비스의 가격 대비 만족도는 어떠셨나요?',          1, 0, 0, 4, 1),
-- 5번: 순위선택
(2, 'RANK',     '중요하다고 생각하는 서비스 요소를 순위대로 정렬해 주세요.', 0, 0, 0, 5, 1),
-- 6번: 조건분기 문항 (1번 SINGLE에서 옵션2 선택 시 활성화)
(2, 'SINGLE',   '왜 만족하신다고 느끼셨나요?',                             1, 2, 0, 6, 1);
